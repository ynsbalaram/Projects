...
dag = DAG(
dag_id='One_Time_Export_Card_Txns_Data',
...
def fetch_card_txns_cmd():
  ...
  command_two = '{{ var.value.card_txns_export_shell_command }}'
  return f'{command_one} && {command_two}'

export_card_txns = SSHOperator(
 task_id='sqoop_export_card_txns',
...
trigger_task >> export_card_txns >> dummy
